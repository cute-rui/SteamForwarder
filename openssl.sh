							            ...
							            alg=$OPTARG #算法
										        ...
										        d)
												            all_domain=$OPTARG #域名,逗号分隔
													                ;;
															        n)
																	            srv_key_name="steamcommunity" #服务器证书名称
																		                ;;
																				        h)
																						            usage
																							                exit 0
																									            ;;
																										            ?)  #当有不认识的选项的时候arg为?
																															    ...
																															    ca_subj="/C=CN/ST=Steam/L=Steam/O=Steam/CN=Forwarder CA"
																															    server_subj="/C=CN/ST=Steam/L=Steam/O=Steam/CN=${domain}"
